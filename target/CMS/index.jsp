        ...
        <div>
            <li><a href='#'><i class='fa fa-inbox'></i><span class='nav-label' style="font-size: 20px">页面管理</span><span class='fa arrow'></span></a>
                <ul class='nav nav-second-level'>
                    ...
                    <li><a class='J_menuItem' href='special/query.do'>专题管理</a></li>
                    <li><a class='J_menuItem' href='index_v3.html'>专区管理</a></li>
                    <li><a class='J_menuItem' href='index_v4.html'>广告管理</a></li>
                    <li><a class='J_menuItem' href='index_v5.html'>搜索管理</a></li>
                    <li><a class='J_menuItem' href='index_v6.html'>更多管理</a></li>
                    <li><a class='J_menuItem' href='index_v7.html'>反馈管理</a></li>
                    <li><a class='J_menuItem' href='index_v8.html'>分类管理</a></li>
                    <li><a class='J_menuItem' href='./view/version/list.jsp'>包月管理</a></li>
                </ul>
            </li>
            ...
            <li><a class='J_menuItem' href='version/query.do'><span class='nav-label' style="font-size: 20px">版本管理</span><span class='fa arrow'></span></a></li>
        </div>
    </nav>
    <!--左侧导航结束-->
    <!--右侧部分开始-->
